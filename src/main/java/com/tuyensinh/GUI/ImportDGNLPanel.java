...
public class ImportDGNLPanel extends JPanel {
    ...
    public ImportDGNLPanel() {
        ...
        setLayout(new GridBagLayout()); // Dùng GridBagLayout để căn giữa toàn bộ Form
        ...
        // 1. Tiêu đề
        JLabel lblTitle = new JLabel("NHẬP ĐIỂM ĐÁNH GIÁ NĂNG LỰC");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(new Color(40, 40, 40));
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        // 2. Mô tả phụ
        JLabel lblDesc = new JLabel("Vui lòng chọn file Excel (.xls, .xlsx) chứa điểm ĐGNL để nạp vào hệ thống");
        ...
        btnImport.addActionListener((ActionEvent e) -> {
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                // Dùng Thread để tránh đơ giao diện khi import file nặng
                new Thread(() -> {
                    try {
                        ...
                        SwingUtilities.invokeLater(() -> {
                            ...
                            JOptionPane.showMessageDialog(this, "Import điểm ĐGNL thành công!", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                        });
