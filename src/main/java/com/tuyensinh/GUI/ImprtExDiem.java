...
public class ImprtExDiem extends JPanel {
        ...
        new DropTarget(dropZone, DnDConstants.ACTION_COPY, new DropTargetAdapter() {
            ...
            public void drop(DropTargetDropEvent dtde) {
                try {
                    ...
                    if (transferable.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                        ...
                        if (!files.isEmpty()) {
                            ...
                            if (file.getName().endsWith(".xlsx") || file.getName().endsWith(".xls")) {
                                ...
                                JOptionPane.showMessageDialog(ImprtExDiem.this,
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(ImprtExDiem.this, "Lỗi đọc file: " + e.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    private void handleFileSelected(File file) {
        ...
        int option = JOptionPane.showConfirmDialog(this,
                "Bạn có chắc chắn muốn nạp điểm thi từ file: " + file.getName() + " ?",
                "Xác nhận Import",
    ...
    private void importFile(File file) {
        ...
        progressBar.setIndeterminate(true); // Hiệu ứng chạy vô tận
    ...
    class DashedDropZone extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.setStroke(dashed);
            g2.setColor(new Color(170, 190, 220)); // Màu xanh lơ nhạt
